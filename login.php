...
<head>
    <meta charset="utf-8">
    <title>Ehospital APD - Login</title>
                ...
                <div class="col-md-6 col-lg-5">
                    <div class="login-box bg-white box-shadow border-radius-10">
                        <div class="login-title">
                            <h2 class="text-center text-primary">Login E-Hospital APD</h2>
                        </div>
                        <form action="logedin.php" method="POST" class="mt-4">
                            <div class="input-group custom">
                                <input type="text" class="form-control form-control-lg" name="nik" placeholder="NIP">
